...
AS
	BEGIN
		SELECT product_group_id, product_group_name, product_group_catgory, product_group_stocking, product_group_status
        FROM product_group 
        WHERE product_group_status = 1 AND product_group_catgory = @CATEGORY_ID
	END
GO
